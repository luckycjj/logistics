      ...
      <ul id="dataList" class="data-list">
        <li v-for="item in pdlist">
          ...
          <div id="sure">
            ...
            <div class="go" v-else-if="type*1 < 10 && type*1 > 0  && orderSource == 1 &&  pdlist[0].fabu.indexOf('1') != -1">
