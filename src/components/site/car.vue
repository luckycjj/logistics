      ...
      go:function(){
        ...
        function setListData(curPageData, num, size,typeNumber){
          ...
          for (var i = 0; i < curPageData.length; i++) {
            ...
            var str = '<div class="top" data-sWeight="'+(pd.zongweight*1000000000 - pd.nowweight*1000000000)/1000000000+'" data-userNow="'+pd.userNow+'" data-driverLicense="'+pd.driverLicense+'" data-pkCar="'+pd.pkCar+'" data-carType="'+pd.carType+'">'+
        ...
        if(!bomb.hasClass("downJian"+Zongtype,"logisticsImg")){
          ...
          function setListData(curPageData, num, size,typeNumber){
            ...
            for (var i = 0; i < curPageData.length; i++) {
              ...
              var img2 = _this.orderPk != "" ?"<div class='checkImg' style='display: "+display3+"'></div>":"";
              var str = "";
              str += '<div class="top" data-sWeight="'+(pd.zongweight*1000000000 - pd.nowweight*1000000000)/1000000000+'" data-userNow="'+pd.userNow+'" data-driverLicense="'+pd.driverLicense+'" data-pkCar="'+pd.pkCar+'" data-carType="'+pd.carType+'">'+
