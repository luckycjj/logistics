...
import  newOrderT from '@/components/newOrder/chooseEnd'
...
import uploadDataF from '@/components/uploadData/uploadDataF'
  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {path: 'chooseEnd', component: newOrderT},
